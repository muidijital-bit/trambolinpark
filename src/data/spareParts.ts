...
export const spareCategories: PartCategory[] = [
  ...
  /* ── 1. Trambolin Yedek Parçalar ──────────────────────────── */
  {
    ...
    items: [
      ...
      { key: 'branda-kilif',         title: 'Trambolin Branda Kılıfı',                 desc: 'Trambolin için koruyucu branda örtüsü, dış mekan kullanımına uygun.',                              image: img('album$trambolinparkyeni$urunler$UfeSdB5BaUUlD6zzatYV.jpg') },
      { key: 'ucgen-halka',          title: 'Üçgen Halka Demir (4×4 cm)',              desc: 'Trambolin zıplama ağı bağlantısı için 4×4 cm üçgen halka demir aparat.',                          image: img('album$trambolinparkyeni$urunler$iiQLF4TLsznmhWQcz52j.jpg') },
      { key: 'orme-plastik-aparat',  title: 'Örme Zıplama Ağı Plastik Aparatı',       desc: 'Örme zıplama ağlarının kasaya montajı için plastik bağlantı aparatı.',                            image: img('album$trambolinparkyeni$urunler$tcOmDrQtZq4UwmitbSEA.jpg') },
      { key: 'zemin-plastik-aparat', title: 'Zemin Trambolin Zıplama Plastik Aparatı', desc: 'Zemin trambolinlerde zıplama ağı montajı için plastik aparat.',                                   image: img('album$trambolinparkyeni$urunler$RocEre6RuObN8Ne0idrG.jpg') },
      { key: 'ayak-stoper',          title: 'Yuvarlak Trambolin Ayak Stoperi',         desc: 'Yuvarlak trambolinlerin zemine kaymamasını engelleyen kauçuk ayak stoperi.',                      image: img('album$trambolinparkyeni$urunler$zZPDV6ffsej1bVoWHFGn.jpg') },
      { key: 'kisa-ayak',            title: 'Trambolin Kısa Ayak',                    desc: 'Trambolin gövdesine bağlanan yedek kısa ayak profili.',                                            image: img('album$trambolinparkyeni$urunler$8MDKvm0UP78MXwPoyLKI.jpg') },
      { key: 'merdiven',             title: 'Trambolin Merdiveni',                    desc: 'Trambolinlere kolay erişim için çelik merdiven aksesuarı.',                                        image: img('album$trambolinparkyeni$urunler$PmeW6NhT6XvRdcCX5vyf.jpg') },
      { key: 'yay-cekme-aparat',     title: 'Trambolin Yayı Çekme Aparatı',           desc: 'Trambolin yaylarının montaj ve sökümünü kolaylaştıran çekme aparatı.',                            image: img('album$trambolinparkyeni$urunler$ovHuiC8vdjoiZNkwAz65.jpg') },
      { key: 'step-branda',          title: 'Step Trambolin Süngerli Koruma Brandası', desc: 'Step trambolinler için yay ve çerçeveyi örten süngerli koruma brandası.',                         image: img('album$trambolinparkyeni$urunler$OyqeJDHSpW2UmVZetN7P.jpg') },
      { key: 'yuvarlak-branda',      title: 'Yuvarlak Trambolin Süngerli Koruma Brandası', desc: 'Yuvarlak trambolinler için yay ve çerçeveyi örten süngerli koruma brandası.',                  image: img('album$trambolinparkyeni$urunler$bYDUHZgF7ZptueN9Uz4I.jpg') },
      { key: 'sunger-kup-blok',      title: 'Sünger Havuzu Küp Blok',                 desc: 'Sünger havuzları için yüksek yoğunluklu yumuşak sünger küp blok dolgu.',                          image: img('album$trambolinparkyeni$urunler$8gOgQOWKG167WRuB5Y0y.jpg') },
      { key: 'roller-makara',        title: 'Roller Kaydırak Kayma Makarası',          desc: 'Roller kaydırak sistemleri için yedek kayma makarası.',                                           image: img('album$trambolinparkyeni$urunler$23geVZcJWREPIdP8Pi3b.jpg') },
      { key: 'boru-kopuk',           title: 'Trambolin Boru Köpüğü',                  desc: 'Trambolin çerçeve borularına geçirilen koruyucu köpük profil.',                                   image: img('album$trambolinparkyeni$urunler$g8h5rMO205jROz6AetdW.jpg') },
    ],
  },
