    ...
    <footer className="bg-dark text-slate-300 py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-12">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center">
              <img src="/logo.png" alt="Trambolinpark Logo" className="h-10 object-contain" />
            </Link>
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                href="https://instagram.com/_trambolinpark_"
                target="_blank" rel="noreferrer"
                aria-label="Instagram"
                className="w-9 h-9 rounded-full bg-white/5 hover:bg-[#9fc91a] flex items-center justify-center transition-colors"
              >
              ...
              <a
                href="https://youtube.com/@trambolinpark"
                target="_blank" rel="noreferrer"
                aria-label="YouTube"
                className="w-9 h-9 rounded-full bg-white/5 hover:bg-[#9fc91a] flex items-center justify-center transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link to="/urunler/trambolinler" className="hover:text-secondary transition-colors text-sm">Trambolinler</Link></li>
              <li><Link to="/urunler/soft-play-havuzlar" className="hover:text-secondary transition-colors text-sm">Soft Play & Havuzlar</Link></li>
              <li><Link to="/urunler/sisme-park" className="hover:text-secondary transition-colors text-sm">Şişme Park</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-sm">
                <span className="block text-slate-500 mb-0.5">Adres</span>
        ...
        <div className="pt-6 md:pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-slate-500 text-center sm:text-left">© {new Date().getFullYear()} TRAMBOLİNPARK — MakroKEY®. Tüm hakları saklıdır.</p>
