...
const SITE_URL = 'https://trambolinpark.com';

// Görünür breadcrumb (nav) ile birebir eşleşen BreadcrumbList yapılandırılmış verisi.
// items[].url göreli (örn. "/urunler") ya da tam URL olabilir.
...
// Meta description için düz metne çevirip belirli uzunlukta kırpar.
export function toMetaDescription(text: string | undefined | null, fallback: string, max = 160): string {
